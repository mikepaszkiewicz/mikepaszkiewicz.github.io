...
(function($){
	$(document).ready(function(){
		...
		$(".contactus").click(function() {
			var bottomPixel = $(document).height()-$(window).height();
			$("body,html").animate({scrollTop: bottomPixel},800);
			$('#name2').focus()
		...
		//scroll contact ID not class for buttons with classes already
		//-----------------------------------------------
		...
		//scroll learn more
			...
			$("body,html").animate({scrollTop:613},800);
		});
		//Modal
		//-----------------------------------------------
		if($(".modal").length>0) {
